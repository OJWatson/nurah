...
- Model summary plots and summaries for assessing identifiability
  against DAG
- Identify where to pull in
  [http://robindenz1.github.io/simDAG/index.html](http://robindenz1.github.io/simDAG/index.md)
  or keep distinct
